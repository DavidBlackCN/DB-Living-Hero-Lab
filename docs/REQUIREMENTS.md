...
当前冻结资产是 `base-albedo.png`。`blink-closed-eyes-v1.png` 与后续整图重试均未通过整图切换验收，后续 Blink 转局部眼部方案；记录见 `validation/`。Normal、区域和语义 Mask、Emission 等尚未制作；四张落叶素材已接入第一版动态覆层。后续能力包括正式 Blink、Breathing、Hair Motion、24h Runtime Lighting。
