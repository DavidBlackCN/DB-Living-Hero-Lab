...
- 原图尺寸：`3840 x 2160`
- 裁切坐标：`x=1940, y=390, width=700, height=470`（左上角为原点，右/下边界不包含）
- 裁切图尺寸：`700 x 470`
...
双眼框仅用于调试显示，仍非最终 Blink coverage mask。

人工验收状态：本轮使用第二版人工校准候选坐标，等待再次人工验收。
debugCrop 是本轮主要生图输入候选，目标是保留完整双眼、眉眼、鼻梁及附近刘海上下文。
